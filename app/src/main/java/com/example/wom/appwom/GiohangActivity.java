            ...
            public void onClick(View v) {
                if(HomeActivity.mangGiohang.size()>0){
                    ...
                    for(int i = 0; i < HomeActivity.mangGiohang.size();i++){
                        id = HomeActivity.mangGiohang.get(i).getIdsp();
                        gia = HomeActivity.mangGiohang.get(i).getGiasp();
                        sl = HomeActivity.mangGiohang.get(i).getSoluongsp();
                        ten = HomeActivity.mangGiohang.get(i).getTensp();
                        txtTongtien.setText(USER_LOGIN_ID);
                    }
                    Toast.makeText(getApplicationContext(),HomeActivity.mangGiohang.toString(),Toast.LENGTH_LONG);
                }else{
