...
public class DienthoaiAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dienthoai_admin);
        Anhxa();
    ...
    private void Anhxa() {
        ...
        listView = (ListView) findViewById(R.id.lvDienthoaiAdmin);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mnAdd:
                Intent i = new Intent(DienthoaiAdmin.this, ThemmoiSanphamAdmin.class);
                startActivity(i);
                break;
            default:
                break;
